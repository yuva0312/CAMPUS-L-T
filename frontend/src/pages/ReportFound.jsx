...
const ReportFound = ({ onReturnToDashboard }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.itemName.trim()) {
      setError('Please enter the general item name.');
      return;
    }

    if (!selectedLocation) {
      setError('Please select or specify the found campus location.');
      return;
    }

    if (!formData.foundDate) {
      setError('Please select the date when the item was found.');
      return;
    }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-section" style={{ marginBottom: '2.5rem' }}>
            ...
            <div className="form-group" style={{ marginBottom: '1.25rem' }}>
              ...
              <input
                ...
                name="itemName"
                className="form-input"
                placeholder="e.g. Leather Wallet, Smartphone, Wireless Earphones"
          ...
          <div className="form-section" style={{ marginBottom: '2.5rem' }}>
            ...
            <div className="form-group" style={{ marginBottom: '1.25rem' }}>
              ...
              <input
                ...
                className="form-input"
                placeholder="e.g. On desk 3 in Room 204"
          ...
          <div className="form-section" style={{ marginBottom: '2.5rem' }}>
            ...
            >
              ...
              <span>
                Private information will only be used for verification.
              </span>
            </div>
            ...
            >
              <div className="form-group">
                ...
                <input
                  ...
                  name="brand"
                  className="form-input"
                  placeholder="e.g. Samsung, HP, Noise"
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  name="colour"
                  className="form-input"
                  placeholder="e.g. Space Gray, Red accent"
            ...
            <div className="form-group" style={{ marginBottom: '1.25rem' }}>
              ...
              <input
                ...
                name="uniqueMark"
                className="form-input"
                placeholder="e.g. Marvel sticker on top lid, key ring with initials"
            ...
            <div className="form-group" style={{ marginBottom: '1.25rem' }}>
              ...
              <input
                ...
                name="specialFeature"
                className="form-input"
                placeholder="e.g. Patterned phone case, silver engraving"
            ...
            <div className="form-group" style={{ marginBottom: '1.25rem' }}>
              ...
              <input
                ...
                name="damage"
                className="form-input"
                placeholder="e.g. Small dent on bottom left corner"
            ...
            <div className="form-group" style={{ marginBottom: '1.25rem' }}>
              ...
              <textarea
                ...
                className="form-input"
                rows="3"
                placeholder="e.g. Found near teacher table, contains library card"
